...
export default function Home() {
    ...
    const { data, isLoading, isError } = api.weight.getWeights.useQuery({});
    ...
    return (
        <>
            ...
            <main className="min-h-screen  items-start justify-center bg-gradient-to-b from-[#12162C] to-[#15162c]">
                ...
                <p className="text-4xl flex justify-center items-center w-full h-full p-20 text-amber-50">Please sign in
...
function WeightList({weightResult}: {weightResult:{ id: number, weight: number, createdAt: Date, updatedAt: Date, createdById: string}[]}) {
    if (!weightResult) {
